...
//
// Purpose: Console commands for debugging and manipulating NPCs. This file also also been edited to include custom commands.
//
//===========================================================================//
...
//------------------------------------------------------------------------------
// Purpose: These are the custom commands for Reverse Kleptomania.
//------------------------------------------------------------------------------

#include <convar.h>
//ConVar var_cats("var_cats", "42", FCVAR_ARCHIVE, "Kittes");
...
void meow_f(void)
{
	Msg("Just the smallest cat on the land...\n");
}
